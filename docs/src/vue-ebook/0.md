...
Nếu bạn đã từng trải qua giai đoạn khởi đầu với jQuery, bạn có thể sẽ ngạc nhiên trước những thay đổi lớn trong lĩnh vực front-end chỉ trong vài năm qua. Trước đây, front-end chủ yếu tập trung vào việc cắt ghép hình ảnh và cấu trúc lại giao diện, chú trọng vào thiết kế trang mà thường bỏ qua phần logic của ứng dụng.

Đó là thời điểm Node.js vừa được ra mắt và vẫn còn trong giai đoạn phát triển. Các nhà phát triển front-end thường sử dụng các mẫu JSP và PHP, và phần lớn công việc của họ chủ yếu là điều chỉnh khả năng tương thích giữa các trình duyệt. Sự xuất hiện của jQuery đã mang lại một phương pháp lập trình mượt mà hơn, với khả năng xử lý chuỗi dễ dàng hơn, cùng với việc cung cấp các yêu cầu bất đồng bộ (Ajax) rất dễ sử dụng và bộ chọn phần tử Sizzle engine cực kỳ tiện lợi. Những tiện ích mà jQuery mang lại đã đáp ứng gần như tất cả nhu cầu trong lĩnh vực front-end vào thời điểm đó, vì vậy không có gì ngạc nhiên khi jQuery được coi như một công cụ ưu việt.

Tôi tin rằng ấn tượng của các nhà phát triển phải viết HTML/CSS/JavaScript vào thời điểm đó về front-end là: tất cả những gì bạn cần là jQuery. Rõ ràng, jQuery là một thư viện xuất sắc, nhưng với sự phát triển của Node.js, cải tiến trong quản lý gói npm, và một cộng đồng mã nguồn mở sôi động, front-end đã nhận được sự hỗ trợ từ hàng triệu nhà phát triển. Họ tham gia vào nhiều lĩnh vực, từ phát triển giao diện web đến xây dựng thư viện công cụ, framework, script và cả phát triển server. JavaScript, với tính năng đơn luồng, không ngừng đổi mới và mở rộng, tạo ra một front-end mạnh mẽ và linh hoạt như chúng ta thấy ngày nay.
